...
# A dictionary to store sessions (so multiple users could chat at once)
store = {}
...
def main():
    ...
    try:
        ...
        print(f"Failed to setup chatbot. Is your database running and API keys set? Error: {e}")
        return
    ...
    session_id = "user_123" # A unique ID for this conversation
